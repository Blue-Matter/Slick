...
The [`openMSE`](openMSE.com) packages are compatible with Slick, and include tools to convert `openMSE` MSE results to the Slick format. For more information on developing Slick objects please see the [Developer's Guide]().
