...
RefPoints(timeseries) <- list(
  list(Name='1.5 BMSY', Value=1.5, Color='blue'),
  list(Name='0.8 FMSY', Value=0.8, Color='orange'),
  list(Name='Target Catch', Value=1200, Color='darkgrey')
)
