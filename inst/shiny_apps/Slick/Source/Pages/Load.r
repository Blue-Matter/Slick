...
LoadUI <- function(id, label="load") {
  ...
  tagList(
    fluidRow(
      ...
      # load object box
      box(title=h4(i18n$t('Load a Slick Object')),
          width=6,
          solidHeader=TRUE,
          status = "primary",
          p(i18n$t('Choose a Slick object from the Example drop-down and click "Select" or load a Slick object from file.')),
